...
temp2 = plt.hist(higgs2_jet_n, bins=jet_n_bin,histtype='step',weights=higgs2_weight,stacked=False,label='doubly charged higgs2')
...
ax1.hist(higgs2_jet_n, bins=jet_n_bin,histtype='step',weights=higgs2_weight,stacked=True,label='higgs2')
...
ax1.legend()
ax1.set_title('Jet Multiplicity Higgs (500GeV) Comparison')
...
ax2.legend()
ax2.set_title('Jet Multiplicity Higgs (500GeV) Expected Significance')
