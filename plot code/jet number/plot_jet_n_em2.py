...
simdata = [triboson_jet_n_em2,top_jet_n_em2,fake_jet_n_em2,diboson_jet_n_em2]
simweight = [triboson_weight_em2,top_weight_em2,fake_weight_em2,diboson_weight_em2]
simdatahigh = [triboson_jet_n_high_em2,top_jet_n_high_em2,fake_jet_n_high_em2,diboson_jet_n_high_em2]
simweighthigh = [triboson_weight_high_em2,top_weight_high_em2,fake_weight_high_em2,diboson_weight_high_em2]
simdatalow = [triboson_jet_n_low_em2,top_jet_n_low_em2,fake_jet_n_low_em2,diboson_jet_n_low_em2]
...
ax1.hist(data_jet_n_em2, bins=jet_n_bin,histtype='step',stacked=False,label='data')
...
ax2.hist(data_jet_n_high_em2, bins=jet_n_bin,histtype='step',stacked=False,label='data')
...
ax3.hist(data_jet_n_low_em2, bins=jet_n_bin,histtype='step',stacked=False,label='data')
