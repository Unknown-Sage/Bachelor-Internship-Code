...
temp2 = plt.hist(higgs_electron_n, bins=electron_n_bin,histtype='step',weights=higgs_weight,stacked=False,label='doubly charged higgs')
...
ax1.hist(higgs_electron_n, bins=electron_n_bin,histtype='step',weights=higgs_weight,stacked=True,label='higgs')
...
ax1.legend()
ax1.set_title('Electron Multiplicity Higgs (300GeV) Comparison')
...
ax2.legend()
ax2.set_title('Electron Multiplicity Higgs (300GeV) Expected Significance')
