...
temp2 = plt.hist(higgs_met, bins=met_bin_higgs,histtype='step',weights=higgs_weight,stacked=False,label='doubly charged higgs')

fig, (ax1, ax2) = plt.subplots(1,2)

ax1.hist(higgs_met, bins=met_bin_higgs,histtype='step',weights=higgs_weight,stacked=False,label='doubly charged higgs')
...
ax1.legend()
ax1.set_title('Missing Transverse Energy Higgs (300GeV) Comparison')
...
ax2.legend()
ax2.set_title('Missing Transverse Energy Higgs (300GeV) Expected Significance')
