...
temp2 = plt.hist(higgs_inv_mass, bins=inv_mass_bin_higgs,histtype='step',weights=higgs_weight,stacked=False,label='doubly charged higgs')


fig, (ax1, ax2) = plt.subplots(1,2)
#fig.suptitle('Invariant Mass')

ax1.hist(higgs_inv_mass, bins=inv_mass_bin_higgs,histtype='step',weights=higgs_weight,stacked=False,label='doubly charged higgs')
