...
inv_mass_bin_higgs = [0,200,400,600,800,1000,1200,1400,1600,1800]
inv_mass_scale = [100,300,500,700,900,1100,1300,1500,1700]

met_bin_higgs = [0,50,100,150,200,250,300,350]
met_scale = [25,75,125,175,225,275,325]

jet_n_bin_higgs = [0,1,2,3,4,5,6]
